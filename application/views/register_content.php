                    ...
                    <form class="form" action="" method="post">
                        ...
                        <div class="field">
                            ...
                            <div class="control control has-icons-right">
                                <input class="input" type="e-mail" placeholder="Nama lengkap">
                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-right">
                                <input class="input" type="tel" placeholder="+62">
                            ...
                            <div class="field has-text-centered">
                                    <span>Sudah punya akun? <a href="<?php echo base_url('/login');?>">Masuk</a></span>
                            </div>
                        </div>
                    </form>                    
            </div>
